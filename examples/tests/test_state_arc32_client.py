...
from examples.smart_contracts.artifacts.state.state_arc32_client import (
    CallAbiArgs,
...
@pytest.fixture
def deployed_state_app_client(state_factory_arc32: StateFactory) -> StateClient:
...
def test_readonly_methods_dont_consume_algos(state_factory_arc32: StateFactory) -> None:
    client, _ = state_factory_arc32.deploy(
        compilation_params={"deploy_time_params": {"VALUE": 1}},
    )
...
def test_arguments_with_defaults(state_factory_arc32: StateFactory) -> None:
    client, _ = state_factory_arc32.deploy(
        compilation_params={"deploy_time_params": {"VALUE": 1}},
    )
