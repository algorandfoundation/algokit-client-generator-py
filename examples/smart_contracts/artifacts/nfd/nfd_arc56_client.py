...
class _NfdInstanceUpdateSend:
    ...
    def update_application(
        ...
        return typing.cast(algokit_utils.SendAppUpdateTransactionResult[None], response)
    ...
    def create_application(
        ...
        *,
        ...
        compilation_params: algokit_utils.AppClientCompilationParams | None = None
            ...
            return NfdInstanceClient(client), typing.cast(algokit_utils.AppFactoryCreateMethodCallResult[None], result)
