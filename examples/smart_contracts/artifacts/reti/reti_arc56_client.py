    ...
    def create_application(
        ...
        *,
        ...
        compilation_params: algokit_utils.AppClientCompilationParams | None = None
            ...
            return ValidatorRegistryClient(client), typing.cast(algokit_utils.AppFactoryCreateMethodCallResult[None], result)
