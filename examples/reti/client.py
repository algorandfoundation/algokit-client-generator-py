...
class ValidatorRegistryFactory(protocols.TypedAppFactoryProtocol[ValidatorRegistryMethodCallCreateParams, None, None]):
    ...
    def create_application(
        ...
        *,
        ...
        compilation_params: applications.AppClientCompilationParams | None = None
            ...
            return ValidatorRegistryClient(client), applications.AppFactoryCreateMethodCallResult[None](
                **{
                    **result.__dict__,
